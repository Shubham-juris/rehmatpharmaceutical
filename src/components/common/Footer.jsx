      ...
      <div className="max-w-7xl mx-auto px-6 py-10 grid gap-10 md:grid-cols-2 lg:grid-cols-4">
        ...
        <div>
          <div className="flex items-center space-x-3 mb-4">
            <img src={logo} alt="Rehmat Pharma Logo" className="w-10 h-10 rounded-full" />
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li>
              <NavLink to="/" className="hover:text-sky-400">Home</NavLink>
            </li>
            <li>
              <NavLink to="/aboutUs" className="hover:text-sky-400">About Us</NavLink>
            </li>
            <li>
              <NavLink to="/service" className="hover:text-sky-400">Our Services</NavLink>
            </li>
            <li>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-400">
            <li><NavLink to="/" className="hover:text-sky-400">Our Team</NavLink></li>
            <li><NavLink to="/" className="hover:text-sky-400">Awards</NavLink></li>
            <li><NavLink to="/" className="hover:text-sky-400">Careers</NavLink></li>
            <li><NavLink to="/" className="hover:text-sky-400">FAQs</NavLink></li>
            <li><NavLink to="/" className="hover:text-sky-400">Privacy Policy</NavLink></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div className="space-y-4 text-gray-300 text-sm">
            ...
            <a
              ...
              className="flex items-start gap-3 hover:text-sky-400"
            >
